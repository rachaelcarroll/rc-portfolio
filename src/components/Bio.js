          ...
          <div className="headshot">
            ...
            <div className="bio-btns">
              <a
                target="_blank"
                rel="noreferrer"
                href="https://drive.google.com/file/d/1g4odGG4w-7cVdVw12lffR9cYBetxVk1E/view?usp=sharing"
              >
                <button className="bio-btn">resume</button>
              </a>
              <Link to="/contact">
                <button className="bio-btn">contact me</button>
              </Link>
            </div>
          </div>
        </Fade>
