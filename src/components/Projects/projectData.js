...
export const projectData = [
    ...
    },
    {
      name: 'ClienTell',
      image: clientell,
      summary: 'A platform empowering sex workers to document and share their date experiences',
      tech: 'GraphQL | ApolloClient | React | Circle CI | SCSS | Cypress | Netlify',
    ...
    },
    {
      ...
      tech: 'React | React Router | Cypress | CSS3 | Vercel | Miro',
      accomplishments: 'My first React application!',
      timeline: '10 days',
